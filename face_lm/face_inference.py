...
def plt_circle(img, cors):
    for i in range(len(cors)):
        cv2.circle(img, tuple(cors[i]), 1, (0, 255, 0), -1 )
...
def plt_show(image, cv_channel=False, sshow=False):
